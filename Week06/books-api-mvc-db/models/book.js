...
class Book {
    ...
    static async getBookById(id) {
        ...
        const sqlQuery = `SELECT * FROM Books WHERE id = @id`; // Parameterised query
    ...
    static async updateBook(id, newBookData) {
        ...
        const sqlQuery = `UPDATE Books SET title = @title, author = @author WHERE id = @id`; // Parameterised query
    ...
    static async deleteBook(id) {
        ...
        const sqlQuery = `DELETE FROM Books WHERE id = @id`; // Parameterised query
        ...
        return result.rowAffected > 0; // Indicate success based on affected rows
    }
}
